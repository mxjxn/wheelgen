...
import '../styles/components/download-controls.css';
  ...
  return (
    <div class="download-controls">
      <div class="download-header">
        <h3 class="section-title">Download Artwork</h3>
        <p class="section-description">Export your artwork in various formats and sizes</p>
      </div>
      ...
      <Show when={cropMode() === 'square'}>
        <div class="option-group">
          <label class="control-label">Square Size:</label>
          <div class="format-buttons">
            <button
      ...
      <Show when={downloadFormat() === 'jpeg'}>
        <div class="option-group">
          <label class="control-label">Quality: {Math.round(jpegQuality() * 100)}%</label>
          <input
            type="range"
            min="0.1"
            max="1.0"
