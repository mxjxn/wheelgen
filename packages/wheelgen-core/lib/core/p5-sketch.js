...
import { rings, palette, innerDot, guidesVisible, backgroundColor, initializeArtwork as initializeArtworkStore } from '../store/artwork';
import { logRingStrokeData } from '../model/particle';
export function mountSketch(container) {
    let pInstance = null;
    ...
    const sketch = (p) => {
        ...
        p.draw = () => {
            ...
            const zoomLevel = window.zoomLevel || 1.0;
