export function drawCalligraphyHorizontalHook(p, options) {
    const { w, h, offsets, saturations, colors, baseColor, curveIntensity = 0, strokeWidth = 0.25, segments = 7, size = 1.0, rotation = 0, progress = 1.0, } = options;
