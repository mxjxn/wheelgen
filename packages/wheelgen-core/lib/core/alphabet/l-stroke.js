export function drawCalligraphyLStroke(p, options) {
    const { w, h, offsets, saturations, colors, baseColor, strokeWidth = 0.25, segments = 7, upwardLength = 1.0, size = 1.0, rotation = 0, progress = 1.0, } = options;
